...
#if ANDROID
namespace juce { void juce_ensureEventsLoopStarted() __attribute__((weak)); }
#endif

static void juceaap_ensureEventsLoopStarted() {
#if ANDROID
    if (juce::juce_ensureEventsLoopStarted != nullptr) {
        juce::juce_ensureEventsLoopStarted();
        return;
    }
#endif
